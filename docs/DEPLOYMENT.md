...
| `GEMINI_API_KEY` | legado; não é mais usado pelo assistente geral | pode remover quando quiser |
| `GEMINI_MODEL` | legado; não é mais usado pelo assistente geral | pode remover quando quiser |
...
|---|---|
| `DB` | D1 `caju-os-prod` |
| `AI` | Workers AI (OCR da RAT e assistente geral) |
