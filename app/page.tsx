...
export default function Home() {
  ...
  return <main className="min-h-screen text-foreground">
    ...
    <section className="min-h-screen lg:pl-[92px] xl:pr-[244px]">
...
function EmployeeInvitePanel({ user }: { user: { getIdToken: () => Promise<string> } | null }) {
  const [email, setEmail] = useState(''); const [role, setRole] = useState<'gerencia'|'n1'|'analista'>('n1'); const [message, setMessage] = useState(''); const [busy, setBusy] = useState(false); const [photo, setPhoto] = useState<string | null>(null);
