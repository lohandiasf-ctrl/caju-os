...
function EmployeeInvitePanel({ user }: { user: { getIdToken: () => Promise<string> } | null }) {
  const [email, setEmail] = useState(''); const [role, setRole] = useState<'gerencia'|'n1'|'analista'>('n1'); const [message, setMessage] = useState(''); const [busy, setBusy] = useState(false);
